...
public class TaskRepoStrategy : IRepositoryStrategy<DomainTask>
{
    ...
    public bool add_item(DomainTask task)
    {
    ...
    public DomainTask get_item(int user_id, int id)
    {
        try
        {
            using (var conn = _dbConnection.GetOpenConnection())
    ...
    public List<DomainTask> get_items(int user_id)
    {
    ...
    public bool update_item(DomainTask new_item, DomainTask old_item)
    {
        using (var conn = _dbConnection.GetOpenConnection())
        {
            SqlTransaction tx = conn.BeginTransaction();
    ...
    public bool delete_item(DomainTask item)
    {
        using (var conn = _dbConnection.GetOpenConnection())
        {
            SqlTransaction tx = conn.BeginTransaction();
